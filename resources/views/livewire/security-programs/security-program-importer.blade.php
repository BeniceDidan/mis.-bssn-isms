        ...
        >
            ...
            <div class="space-y-4 px-6 py-5">
                <p class="text-sm text-gray-600">
                    Unggah file "Manajemen Keamanan Informasi.xlsx" sesuai template resmi. Baris dengan nomor
                    program kerja yang sudah ada akan <strong>diperbarui</strong>.
                </p>
                ...
                <div>
                    <input
                        ...
                        wire:model="file"
                        accept=".xlsx,.xls"
                        class="block w-full text-sm text-gray-600 transition-colors duration-150 file:mr-3 file:rounded-full file:border-0 file:bg-emerald-100 file:px-3 file:py-2 file:text-sm file:font-medium file:text-emerald-700 file:transition-all file:duration-300 file:ease-spring hover:file:scale-105 hover:file:bg-emerald-200"
                    >
            ...
            <div class="flex items-center justify-end gap-2 border-t border-white/40 px-6 py-4">
                ...
                <button
                    ...
                    wire:target="import"
                    x-ripple
                    class="rounded-full bg-gradient-to-r from-emerald-500 to-emerald-600 px-4 py-2 text-sm font-medium text-white shadow-lg shadow-emerald-500/30 transition-all duration-300 ease-spring hover:scale-105 hover:shadow-emerald-500/50 active:scale-95 disabled:opacity-50"
                >
