        ...
        >
            ...
            <div class="space-y-4 px-6 py-5">
                <p class="text-sm text-gray-600">
                    Unggah file register "Manajemen Data dan Informasi.xlsx" sesuai template resmi (sheet
                    <span class="font-mono">Log Manajemen Data & Informasi</span>). Baris dengan
                    <span class="font-mono">Risk No</span> yang sudah ada akan <strong>diperbarui</strong>.
                </p>
