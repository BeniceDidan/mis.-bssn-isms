                ...
                <div class="space-y-4 px-6 py-5">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" wire:model="subject" class="w-full rounded-lg border-white/60 bg-white/50 text-sm transition-all duration-300 ease-spring focus:scale-[1.01] focus:border-sky-400 focus:ring-sky-400">
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-700">Ancaman</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Target Waktu</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            >
                            <datalist id="hr-status-suggestions">
                                <option value="Diajukan"><option value="Aktif Terkendali"><option value="Selesai">
                            </datalist>
                        </div>
                        <div>
                    ...
                    <div class="border-t border-white/40 pt-4">
                        ...
                        <div class="space-y-2">
                            @foreach ($dynamicRows as $index => $row)
                                <div class="flex items-center gap-2" wire:key="hr-dynamic-row-{{ $index }}">
