            ...
            <form wire:submit="save">
                <div class="flex items-center justify-between border-b border-white/40 px-6 py-4">
                    <h2 class="text-lg font-semibold text-gray-900">
                        {{ $changeId ? 'Ubah Perubahan' : 'Perubahan Baru' }}
                    </h2>
                ...
                <div class="space-y-4 px-6 py-5">
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-700">Judul / Usulan Modifikasi</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Jenis Perubahan</label>
                            <select wire:model="change_type" class="w-full rounded-lg border-white/60 bg-white/50 text-sm transition-all duration-300 ease-spring focus:border-sky-400 focus:ring-sky-400">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Kategori Perubahan</label>
                            <input
                                type="text"
                            ...
                            <datalist id="category-suggestions">
                                <option value="Major"><option value="Minor">
                            </datalist>
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-700">Prioritas Eksekusi</label>
                            <input
                                type="text"
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-700">Keputusan Penanganan Perubahan</label>
                        <input
                            type="text"
                        ...
                        <datalist id="decision-suggestions">
                            <option value="Terima Risiko Berbekal Mitigasi">
                            <option value="Terima Risiko Tanpa Mitigasi">
                            <option value="Tolak Perubahan">
                        </datalist>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <datalist id="status-suggestions">
                                ...
                                <option value="Disetujui & Selesai">
                    ...
                    <div>
                        ...
                        <input type="text" list="change-personnel-suggestions" wire:model="personnel_ref" placeholder="Pilih dari SDM yang sudah ada, atau ketik kode baru" class="w-full rounded-lg border-white/60 bg-white/50 text-sm transition-all duration-300 ease-spring focus:scale-[1.01] focus:border-sky-400 focus:ring-sky-400">
                        <datalist id="change-personnel-suggestions">
                    ...
                    <div class="border-t border-white/40 pt-4">
                        <div class="mb-2 flex items-center justify-between">
                            <label class="text-sm font-medium text-gray-700">Data Dinamis (Detail Penilaian Risiko, Rollback Plan, dst.)</label>
                        ...
                        <div class="space-y-2">
                            @foreach ($dynamicRows as $index => $row)
                                <div class="flex items-center gap-2" wire:key="change-dynamic-row-{{ $index }}">
                                    <input
                                        type="text"
                                        placeholder="Nama Kolom (mis. Dampak Operasional)"
                                        wire:model="dynamicRows.{{ $index }}.key"
                                        class="w-2/5 rounded-lg border-white/60 bg-white/50 text-sm focus:border-sky-400 focus:ring-sky-400"
                                    >
                                    <input
                                        type="text"
                                        placeholder="Nilai"
                                        wire:model="dynamicRows.{{ $index }}.value"
                                        class="flex-1 rounded-lg border-white/60 bg-white/50 text-sm focus:border-sky-400 focus:ring-sky-400"
                                    >
