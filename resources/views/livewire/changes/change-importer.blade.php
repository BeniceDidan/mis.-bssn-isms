        ...
        >
            ...
            <div class="space-y-4 px-6 py-5">
                <p class="text-sm text-gray-600">
                    Unggah file register "Manajemen Perubahan.xlsx" sesuai template resmi (sheet
                    <span class="font-mono">Log Manajemen Perubahan</span>). Baris dengan
                    <span class="font-mono">Change No</span> yang sudah ada akan <strong>diperbarui</strong>,
                    bukan diduplikasi.
                </p>
